  ...
  >
    ...
    <div class="absolute inset-0 flex items-center justify-center z-10 mx-2.5">
      <div class="bg-black bg-opacity-50 p-8 rounded-lg text-center text-white">
        ...
        <a
          class="flex justify-center items-center mx-auto px-5 py-3 w-52 sm:w-80 sm:px-7 sm:py-5 bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-600 text-white rounded-md transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:brightness-110 active:scale-95"
          href="#contact"
